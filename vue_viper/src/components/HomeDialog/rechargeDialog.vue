        ...
        <el-card shadow="never" width="400px" class="dialogcard">
          ...
          <div style="display: flex;justify-content: center;">
            <el-form label-position="left"  ref="consumpForm" :rules="consumpRules" :model="consumpForm" label-width="80px">
              ...
              <el-form-item label="充值福利:">
                <el-select v-model="consumpForm.discount" @change="consumpChange" placeholder="暂时没有福利活动哦" :class="{'discount': consumpForm.discount!==1, 'nodiscount': consumpForm.discount===1}">
                  <el-option
              ...
              <el-form-item label="实际充值:" style="font-weight: bold;">
